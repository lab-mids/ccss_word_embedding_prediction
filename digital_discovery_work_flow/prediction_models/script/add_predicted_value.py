...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Add a Predicted_Value column to CSV files.")
    parser.add_argument("--input_file", required=True, help="Input CSV file")
    parser.add_argument("--source_column", required=True, help="Source column to copy data from")
