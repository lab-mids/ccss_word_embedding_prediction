...
def parse_args():
    ...
    parser.add_argument(
        "--marker_size", type=int, default=25, help="Size of the markers in the plot"
    )
    parser.add_argument(
        "--axisfont_size", type=int, default=25, help="Font size for the axis labels"
    )
    parser.add_argument(
        "--tickfont_size", type=int, default=20, help="Font size for the tick labels"
    )
    ...
    parser.add_argument(
        ...
        const=True,
        default=False,
        help="Whether to show legend in the plot",
    )
    parser.add_argument(
        "--textfont_size",
        type=int,
