...
def plot_stacked_step_histogram(
    dataframes, system_names, bins=10, column_name="Current_at_850mV"
):
...
def parse_args():
    ...
    parser.add_argument(
        "--output_path", type=str, required=True, help="Output path for the plot PDF"
    )
    parser.add_argument(
        "--bins", type=int, default=10, help="Number of bins for the histogram"
    )
    parser.add_argument(
        "--column_name",
        type=str,
...
def main():
    ...
    fig = plot_stacked_step_histogram(
