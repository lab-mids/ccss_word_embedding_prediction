...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Integrated Density Combined X Plot with multiple files and plot types.")
    ...
    parser.add_argument("--fontsize", type=int, default=14,
                        help="Font size for text elements.")
    parser.add_argument("--subplot_width", type=float, default=7,
                        help="Width of each subplot in inches.")
    parser.add_argument("--subplot_height", type=float, default=5,
