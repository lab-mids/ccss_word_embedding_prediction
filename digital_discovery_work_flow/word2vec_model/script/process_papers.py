...
def parse_args():
    ...
    parser.add_argument("--input_path", type=str, required=True, help="Input path for the collected papers CSV file")
    parser.add_argument("--output_path", type=str, required=True, help="Output path for the processed papers CSV file")
