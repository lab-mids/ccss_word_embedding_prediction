...
def parse_args():
    ...
    parser.add_argument("--config_path", type=str, required=True, help="Path to the configuration file for ScopusDataSource")
    parser.add_argument("--keywords", type=str, required=True, help="Keywords for the paper query")
    parser.add_argument("--startyear", type=int, help="Start year for the paper query (optional)")
    parser.add_argument("--endyear", type=int, required=True, help="End year for the paper query")
    parser.add_argument("--openaccess", type=bool, required=True, help="Search for open access papers")
    parser.add_argument("--output_path", type=str, required=True, help="Output path for the collected papers CSV file")
