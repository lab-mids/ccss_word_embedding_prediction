...
def parse_args():
    ...
    parser.add_argument("--input_path", type=str, required=True, help="Input path for the processed papers CSV file")
    parser.add_argument("--model_path", type=str, required=True, help="Output path for the generated word2vec model")
    parser.add_argument("--sg", type=int, default=1, help="Training algorithm: 1 for skip-gram, 0 for CBOW")
    parser.add_argument("--vector_size", type=int, default=200, help="Dimensionality of the word vectors")
    parser.add_argument("--hs", type=int, default=1, help="If 1, hierarchical softmax will be used for model training")
